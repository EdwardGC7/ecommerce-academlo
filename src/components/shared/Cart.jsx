    ...
    <section className="cart">
      ...
      <div className='cart-container'>
      {
        cartProducts?.map(product => (
          <ProductCartInfo key={product.id} getAllProductsCart={getAllProductsCart} product={product}/>
        ))
      }
      </div>
      ...
      <footer className='cart__footer'>
        ...
        <p className="cart__total-global-value"><span className="cart__total-global-label">Total: $</span> {totalPrice}</p>
